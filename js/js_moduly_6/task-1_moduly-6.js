...
// ассив.Т.е.нельзя использовать for, splice, push и т.п.мутирующие методы.
...
// ------приклад розбору---3-варіанти функція -стрілка- деструктиризація-
// const a = users.map(
//     function(el){
//         el.balance = 0;
//         return el
...
// //  деструктиризація-
// const b = users.map(({balance}, i, arr)=>{
//     balance=0;
//     return arr[i];
// });
...
// // стрілка
// console.log(b);
// const c = users.map((e)=> {return {...e, balance:0}});
// console.log(c);